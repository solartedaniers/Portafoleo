    ...
    >
      ...
      <div className="relative z-10 w-[95%] max-w-6xl">
        <header className="w-full flex justify-center mb-8">
          <button
            className="select-none text-white px-6 py-2 rounded-full transition-all duration-300 bg-red-600/60 hover:bg-[#c4af37] hover:text-black shadow-md"
            style={{ fontFamily: "'Irish Grover', cursive", fontSize: "1.6rem" }}
          >
            Mis proyectos
          </button>
        </header>
          ...
          {cards.map((c) => (
            ...
            >
              <div className="p-6 flex flex-col items-center gap-4">
                ...
                {/* Title with darker silver and blinking effect */}
                <h3
                ...
                {/* Lenguajes y herramientas - larger and left-aligned */}
                ...
                {/* Cuadros de herramientas con sonido y elegante hover */}
